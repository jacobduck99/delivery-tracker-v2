...
export function BreakButtonModal({ setBreakSelection, showBreakModal }) {
    return (
        <div className="flex space-x-6">
            <button
                className="w-35 bg-red-600 text-white py-2.5 rounded-full font-semibold hover:bg-red-700" 
                onClick={() => { setBreakSelection(15); showBreakModal(false)}}>
                15 minute break
            </button>
            ...
            <button
                ...
                onClick={() => {setBreakSelection(30); showBreakModal(false)}}>
                    30 minute break
            </button>
            </div>
